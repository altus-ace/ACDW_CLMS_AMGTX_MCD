...
AS
    ...
    INSERT INTO adw.Claims_Details
		...
		SELECT cl.ClaimID						 AS seq_Claim_ID				--SEQ_CLAIM_ID,					
			...
			, cHdr.PatientID		    			 AS Subscriber_ID				--[SUBSCRIBER_ID],				
	  ...
	  FROM ast.Claim_04_Detail_Dedup ast
		  ...
		  JOIN adi.Steward_BCBS_InstitutionalClaim cHdr
			 ON astHdr.LatestClaimAdiKey = cHdr.InstitutionalClaimKey		  
			 		and astHdr.SrcClaimType = 'INST'
