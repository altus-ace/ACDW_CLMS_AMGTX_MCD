...
BEGIN TRAN
						...
						DECLARE @JobName VARCHAR(100) = 'AMGTX_MDCD MbrMember';
	...
	EXEC				amd.sp_AceEtlAudit_Open 
						...
						, @ErrorName = @ErrorName
						;
	--			DECLARE @DataDate DATE = '2021-04-15' DECLARE @LoadType VARCHAR(1) = 'P' DECLARE @ClientID INT = 22 DECLARE @EffectiveDate DATE = '2021-04-01'
