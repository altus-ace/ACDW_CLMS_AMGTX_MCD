...
AS 
    ...
    SELECT           
		...
		,cHdr.PatientID		  				  AS SUBSCRIBER_ID				   --SUBSCRIBER_ID				SUBSCRIBER_ID				
    ...
    FROM ast.Claim_04_Detail_Dedup ast
	   JOIN adi.Steward_BCBS_RXClaim cl
		  ...
		  JOIN adi.Steward_BCBS_RXClaim cHdr
			 ON astHdr.LatestClaimAdiKey = cHdr.RXClaimKey
			 and astHdr.SrcClaimType = 'RX'
    ;
